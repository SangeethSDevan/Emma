    ...
    return (
        <div className="h-[100dvh]  flex flex-col font-outfit justify-center md:items-center p-3">
            <div>
                ...
                <p className="md:text-2xl text-xl font-bold">Visit our <Link to={"/"} replace={true}><span className="text-blue-600 hover:text-red-600 font-mono">/home</span></Link> route</p>
            </div>
        </div>
    )
}
